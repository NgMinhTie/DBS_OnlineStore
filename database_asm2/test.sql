...
DELETE FROM CusNumPhone WHERE AccountID IN (SELECT AccountID FROM Customer);
...
-- test add procedure
-- CALL AddNewCustomer(3, 150, NULL, 'Smith', 'Doe', '1985-07-21', 'Male', '123 Elm St', 08965795322);
-- SELECT * FROM Customer WHERE AccountID = 3;
-- SELECT * FROM CusNumPhone WHERE AccountID = 3;

-- Insert test data
INSERT INTO Customer (AccountID, CusPoint, FName, MName, LName, DOB, Gender, Address)
VALUES (2, 50, 'Alice', 'B', 'Green', '1991-06-15', 'Female', '789 Oak St');
CALL UpdateCustomerPoints(2, 200);
SELECT * FROM Customer WHERE AccountID = 2
